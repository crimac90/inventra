...
Este repositorio reúne la documentación de análisis y diseño del proyecto, desarrollada como trabajo de grado del programa Análisis y Desarrollo de Software del SENA.

## Estado del proyecto

Fase de análisis y diseño. La construcción del software (backend, frontend y base de datos) se realizará en la etapa siguiente; el proceso de despliegue se documentará en ese momento.
